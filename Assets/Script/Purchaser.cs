...
//https://unity3d.com/ru/learn/tutorials/topics/ads-analytics/integrating-unity-iap-your-game
...
public class Purchaser : MonoBehaviour, IStoreListener
{
    ...
    public void InitializePurchasing()
    {
        ...
        builder.AddProduct(beerKey, ProductType.NonConsumable);
    ...
    /// <summary>Купить постоянный товар</summary>
    ...
    /// <summary>Купить подписку</summary>
    ...
    /// <summary>Купить пиво для развработчиков</summary>
    public void BuyBeer()
    {
        BuyProductID(beerKey);
    }
    ...
    /// <summary>Восстановление покупки (Apple)</summary>
